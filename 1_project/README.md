...
После обучения мы дали компьютеру тестовые данные и попросили его предсказать виды цветков. Затем мы сравнили его ответы с правильными ответами и посмотрели, насколько он был прав.

Результат показал, что компьютер угадал все цветки правильно.
